...
public class PageInfo {
    ...
    private int total; // 总记录 数
    private List rows; //显示的记录列表，名称必须是rows  
	...
	public String toString() {
		return "PageInfo [nowpage=" + nowpage + ", condition=" + condition
				+ ", from=" + from + ", order=" + order + ", pagesize="
				+ pagesize + ", rows=" + rows + ", size=" + size + ", sort="
				+ sort + ", total=" + total + "]";
	}
}