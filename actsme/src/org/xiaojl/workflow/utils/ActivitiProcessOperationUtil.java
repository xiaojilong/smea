package org.xiaojl.workflow.utils;
...
import org.xiaojl.commons.utils.UUIDHexGenerator;
 ...
 *
 */
public class ActivitiProcessOperationUtil {
	@Autowired
    ...
    public void jointProcess(String taskId, List<String> userCodes)  
        ...
        for (String userCode : userCodes) {  
            TaskEntity task = (TaskEntity) taskService.newTask(UUIDHexGenerator.generate());  
