...
$(function() {
    organizationTree = $('#organizationTree').tree({
        url : '${pageContext.request.contextPath }/organization/tree.do',
        parentField : 'pid',
        lines : true,
    ...
    dataGrid = $('#dataGrid').datagrid({
        url : '${pageContext.request.contextPath }/user/dataGrid.do',
        fit : true,
        striped : true,
        rownumbers : true,
        pagination : true,
        ...
        }, 
        {
            ...
            formatter : function(value, row, index) {
                var str = '';
                    <myfst:frameSecurity link="/user/edit.do">
                        str += $.formatString('<a href="javascript:void(0)" class="user-easyui-linkbutton-edit" data-options="plain:true,iconCls:\'icon-edit\'" onclick="editFun(\'{0}\');" >编辑</a>', row.id);
                    </myfst:frameSecurity>    
                    <myfst:frameSecurity link="/user/delete.do">
                        str += '&nbsp;&nbsp;|&nbsp;&nbsp;';
...
function addFun() {
    parent.$.modalDialog({
        ...
        width : 500,
        height : 300,
        href : '${pageContext.request.contextPath }/user/addPage.do',
        buttons : [ {
        		text : '取消添加',
            	iconCls:'icon-cancel',
            	handler:function(){
...
function editFun(id) {
    ...
    parent.$.modalDialog({
        ...
        width : 500,
        height : 300,
        href : '${pageContext.request.contextPath }/user/editPage.do?id=' + id,
        buttons : [ {
        		text : '取消修改',
            	iconCls:'icon-cancel',
            	handler:function(){
...
<body class="easyui-layout" data-options="fit:true,border:false">
    ...
    <div id="toolbar" style="display: none;">
        <myfst:frameSecurity link="/user/add.do">
