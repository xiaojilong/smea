...
<script type="text/javascript">
    ...
    $(function() {
        resourceTree = $('#resourceTree').tree({
            url : '${pageContext.request.contextPath }/resource/allTrees.do',
            parentField : 'pid',
            lines : true,
            checkbox : true,
            ...
            onLoadSuccess : function(node, data) {
                progressLoad();
                $.post( '${pageContext.request.contextPath }/role/findResourceIdListByRoleId.do', {
                    id : '${id}'
                }, function(result) {
                    var ids;
        ...
        $('#roleGrantForm').form({
            url : '${pageContext.request.contextPath }/role/grant.do',
            onSubmit : function() {
                progressLoad();
