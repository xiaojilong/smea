...
<html lang="en">
	<head>
		...
		.commitbox{width:79%; padding-left:81px; padding-top:20px; position:absolute; top:0px; z-index:99999;}
		.commitbox_inner{width:96%; height:235px;  margin:6px auto; background:#efefef; border-radius:5px;}
		.commitbox_top{width:100%; height:350px; margin-bottom:10px; padding-top:5px; background:#FFF; border-radius:5px; box-shadow:1px 1px 3px #e8e8e8;}
