...
<html lang="en">
	<head>
		...
		.commitbox{width:96%; padding-left:10px; padding-top:20px; position:absolute; top:0px; z-index:99999;}
		.commitbox_inner{width:96%; height:96%;  margin:6px auto; background:#efefef; border-radius:5px;}
		.commitbox_top{width:100%; height:96%; padding-top:5px; background:#FFF; border-radius:5px; box-shadow:1px 1px 3px #e8e8e8;}
...
<body>
	...
	<input type="hidden" name="isListPageShow" id="isListPageShow" value="是" />
	<input type="hidden" name="isDetailPageShow" id="isDetailPageShow" value="是" />
	<div id="dialog-add">
		        ...
		        <div class="commitbox_top">
		        	...
		        	<table style="width:100%">
		        		<tr>
		        			...
		        			<td style="padding-left: 16px;text-align: right;">数据类型：</td>
		        		...
		        		<tr>
		        			<td style="padding-left: 16px;text-align: right;">列表显示：</td>
		        			<td style="padding-bottom: 6px;">
		        				<label style="float:left;padding-left: 20px;"><input name="form-field-radiol" id="form-field-radio6" onclick="isListPageShow('是');" type="radio" value="icon-edit" checked="checked"><span class="lbl">是</span></label>
								<label style="float:left;padding-left: 20px;"><input name="form-field-radiol" id="form-field-radio7" onclick="isListPageShow('否');" type="radio" value="icon-edit"><span class="lbl">否</span></label>
							</td>
		        			<td style="padding-left: 16px;text-align: right;">详情显示：</td>
		        			<td style="padding-bottom: 6px;">
		        				<label style="float:left;padding-left: 20px;"><input name="form-field-radiod" id="form-field-radio8" onclick="isDetailPageShow('是');" type="radio" value="icon-edit" checked="checked"><span class="lbl">是</span></label>
								<label style="float:left;padding-left: 20px;"><input name="form-field-radiod" id="form-field-radio9" onclick="isDetailPageShow('否');" type="radio" value="icon-edit"><span class="lbl">否</span></label>
							</td>
		        		</tr>
		        			...
		        			<td style="padding-left: 16px;" colspan="100">
		        				<font color="red" style="font-weight: bold;">
		        					注意：<br/>
		        					  ...
		        					  2. 主键为  类名_ID 格式，所有字段的字母均用大写<br/>
		        					  3. 约定俗成：需要保存记录创建信息时，请按照下列规则填写<br/>
		        					           创建时间：CREATE_TIME前台录入为：否   默认值为：空<br/>
		        					  	创建人：CREATE_ACCOUNT前台录入为：否   默认值为：空<br/>
									           创建人姓名：CREATE_NAME前台录入为：否   默认值为：空<br/>
										创建单位 ：CREATE_ORGANIZATION前台录入为：否   默认值为：空<br/>
		        				</font>
							</td>
		        		</tr>
		        	</table>
	...
	<form action="createCode/proCode.do" name="Form" id="Form" method="post">
		...
		<table style="margin-top: 10px;" border="0">
			<tr>
				...
				<td>&nbsp;&nbsp;例如:org.xiaojl.controller.<font color="red" style="font-weight: bold;">system</font>&nbsp;&nbsp;红色部分</td>
			</tr>
		</table>
		<table border="0">
			<tr>
		...
		<table id="table_report" class="table table-striped table-bordered table-hover">
				...
				<thead>
					<tr>
						...
						<th class="center" style="width:80px;">类型</th>
						<th class="center">备注</th>
						<th class="center" style="width:59px;">前台录入</th>
						<th class="center" style="width:59px;">列表显示</th>
						<th class="center" style="width:59px;">详情显示</th>
						<th class="center">默认值</th>
						<th class="center" style="width:75px;">操作</th>
					</tr>
				</thead>
