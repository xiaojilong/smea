package org.xiaojl.controller.system.login;
...
import org.xiaojl.entity.system.Menu;
import org.xiaojl.entity.system.Role;
import org.xiaojl.entity.system.User;
import org.xiaojl.entity.system.vo.LoginVO;
...
import org.xiaojl.util.DateUtil;
import org.xiaojl.util.PageData;
import org.xiaojl.util.RightsHelper;
...
public class LoginController extends BaseController {
	...
	public Object login()throws Exception{
		...
		JSONObject jsonObj = new JSONObject().fromObject(keydata);
		LoginVO loginVo = (LoginVO) JSONObject.toBean(jsonObj, LoginVO.class);
		
		if(null != loginVo && loginVo.getLoginname()!=null && loginVo.getPassword()!=null && loginVo.getCode()!=null){
			//shiro管理的session
			...
			if(null == code || "".equals(code)){
				...
				String USERNAME = loginVo.getLoginname();
				...
				if(Tools.notEmpty(sessionCode) && sessionCode.equalsIgnoreCase(code)){
					...
					if(pd != null){
						...
						user.setORGANIZATION(pd.getString("ORGANIZATION"));
