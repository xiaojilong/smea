package org.xiaojl.controller.system.organization;
...
import org.xiaojl.service.system.organization.OrganizationService;
...
public class OrganizationController extends BaseController {
	...
	public ModelAndView save() throws Exception{
		...
		pd.put("CRATE_TIME", Tools.date2Str(new Date()));	//创建时间
		pd.put("CREATE_ACCOUNT", getCurrentUser().getUSERNAME());	//创建人
		pd.put("CREATE_NAME", getCurrentUser().getNAME());	//创建人姓名
		pd.put("CREATE_ORGANIZATION", getCurrentUser().getORGANIZATION());	//创建部门
	...
	public ModelAndView exportExcel(){
		...
		try{
			...
			for(int i=0;i<varOList.size();i++){
				...
				vpd.put("var4", varOList.get(i).getString("CRATE_TIME"));	//4
				vpd.put("var5", varOList.get(i).getString("CREATE_ACCOUNT"));	//5
				vpd.put("var6", varOList.get(i).getString("CREATE_NAME"));	//6
				vpd.put("var7", varOList.get(i).getString("CREATE_ORGANIZATION"));	//7
				varList.add(vpd);
			}
